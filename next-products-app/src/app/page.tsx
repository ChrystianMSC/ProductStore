...
const Login = () => {
  ...
  return (
    <div className="h-screen bg-[radial-gradient(circle_at_top_left,_#3b3b3f,_#1a1a1d)] flex justify-center items-center font-['Roboto']">
      <div className="bg-black/90 rounded-2xl p-12 shadow-[0_0_30px_rgba(255,105,0,0.3),_0_0_15px_rgba(255,105,0,0.15)] min-w-[320px] max-w-[400px] flex flex-col gap-6 text-gray-100">
        <h1 className="font-bold text-3xl tracking-wide mb-4 text-center text-[#ff6900]">
          Welcome Back
        </h1>
        <input
        ...
        <button
          className="bg-[#101010] rounded-xl p-4 font-semibold text-lg text-[#ff6900] hover:bg-[#505050] transition duration-300"
